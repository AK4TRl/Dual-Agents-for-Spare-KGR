...
# parser.add_argument("--pretrained", type=str, default="conve", choices=["conve", "complex"],
#                     help="Pre-trained embeddings to use without reward shaping, conve OR complex")
...
parser.add_argument('--model', type=str, default='point.rs.conve',
...
parser.add_argument('--use_action_space_bucketing', action='store_true', default=True,
...
parser.add_argument('--set_embedding', action="store_true", default=True,
                    help="set the pretrained embeddings")
parser.add_argument("--freeze", action="store_true", default=False,
                    help="freeze or train the pretrained embeddings")

# Optimization
parser.add_argument('--num_epochs', type=int, default=240,
                    help='maximum number of pass over the entire training set (default: 20)')
parser.add_argument('--num_wait_epochs', type=int, default=30,
...
parser.add_argument('--conve_state_dict_path', type=str, default='/data/weijinhui/KG/QSDRC0/model/NELL23K-cuda0-conve-RV-xavier-200-200-0.003-32-3-0.3-0.3-0.2-0.1/model_best.tar',
...
parser.add_argument('--num_paths_per_entity', type=int, default=-1,
...
parser.add_argument('--seed', type=int, default=543, metavar='S',
                    help='random seed (default: 543, 123)')

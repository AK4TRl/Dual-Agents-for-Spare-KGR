...
# from utils.ops import var_cuda, int_var_cuda, int_fill_var_cuda


class EmbeddingBasedMethod(LFramework):
    def __init__(self, args, kg, mdl, ra=None, secondary_kg=None, tertiary_kg=None):
        super(EmbeddingBasedMethod, self).__init__(args, kg, mdl, ra)
